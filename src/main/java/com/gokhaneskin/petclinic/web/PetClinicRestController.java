...
import com.gokhaneskin.petclinic.exception.InternalServerException;
...
public class PetClinicRestController {
    ...
    public ResponseEntity<?> updateOwner(@RequestBody Owner ownerReq,@PathVariable("id") Long id){
        try {
